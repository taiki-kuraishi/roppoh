...
// Public page — no .layout (no auth guard). Ported from
// Apps/ura-roppoh/src/pages/login/page.tsx; <SsgoiTransition> dropped
// (decision #6), rebranded "Ura Roppoh"/"Roppoh" -> "Web Console".
      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <FieldDescription className="px-6 text-center">
            Web Console is Roppoh's admin console.
          </FieldDescription>
        </div>
      </div>
    </div>
