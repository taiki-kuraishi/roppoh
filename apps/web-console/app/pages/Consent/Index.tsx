...
// Public page — no .layout. Ported from apps/ura-roppoh/src/pages/consent/page.tsx;
// React-router's useSearchParams() -> plain URLSearchParams over
// GlobalThis.location.search (query state stays entirely client-side, per
// Decision #1). Rebranded "Ura Roppoh"/"Roppoh" -> "Web Console".
